...
It allows you to store vocabulary you have already learned
and run simple tests to check how well you remember it.

You can store words in different tables and test yourself from the
contents of one table or all words you have inserted so far.
...
Right now this app is in early development so bugs may occur.

I will be thankful for all bug reports and feedback.
